...
const AcademySection: React.FC = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      desc: "Develop cross-platform mobile apps with React Native and Flutter.",
      icon: (
        <svg width={18} height={18} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
    ...
    {
      tag: "TRACK_03",
      title: "Tech Product Founder",
      desc: "Develop and launch a real product, learning lean startup principles and growth strategies.",
      icon: (
        <svg width={18} height={18} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 64, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.45)", lineHeight: 1.8, maxWidth: 440, marginBottom: 32 }}>
                Our academy isn't just a bootcamp — it's a launchpad. Industry practitioners teach what actually works in production, mentoring students from zero knowledge to job-ready professionals and tech founders.
              </p>
