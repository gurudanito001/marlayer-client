            ...
            <div className="max-w-[1200px] mx-auto w-full px-6 lg:px-16 py-24">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-10 group">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <Link href="/software/Projects/looseapp" className="inline-block w-fit px-8 py-3 rounded-full border border-gray-300 text-sm font-semibold text-gray-900 hover:bg-[#45B1A0] hover:text-white hover:border-[#45B1A0] transition duration-300 shadow-sm">
                            Explore Project
                        </Link>
                    </div>
                </div>
