    ...
    <section id="studentDiscount" className="bg-neutral">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <article className="flex flex-col py-14 lg:py-28 px-5 xl:pl-28">
          <h2 className="text-2xl font-semibold text-secondary border-b mb-5">For Enterprises</h2>
          <h3 className=" text-4xl xl:text-6xl font-extrabold mt-auto text-primary">Empower Your Workforce with Customized Learning</h3>
          ...
          <div className="mt-7">
            <Link href="/learning/contact-sales" className="btn btn-lg bg-secondary text-white shadow-sm rounded-lg px-10">Contact Sales Team</Link>
          </div>
        </article>
