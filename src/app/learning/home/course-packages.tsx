...
const CoursePackages = ()=>{
  ...
  return (
    <section id="coursePackages" className="bg-white py-14 lg:py-28 px-5 lg:px-28 flex flex-col sm:px-12">
      <h3 className="text-3xl max-w-550 mb-5 font-bold text-primary">Courses on Marlayer</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5  w-full rounded-3xl md:rounded-none">
        <article className=" flex flex-col p-3 border border-primary rounded-lg hover:shadow-xl max-w-md">
        ...
        <article className="text-primary flex flex-col p-3 border border-primary rounded-lg hover:shadow-xl max-w-md">
