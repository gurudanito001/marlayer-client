    ...
    <section id="studentDiscount" className="bg-primary text-white py-14 lg:py-28 px-5 xl:px-28">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <article className="flex flex-col lg:pb-20">
          <h1 className=" text-3xl md:text-5xl lg:text-6xl font-extrabold mt-auto">Student Savings:</h1>
          <h1 className=" text-3xl md:text-5xl lg:text-6xl font-semibold">Enjoy special discounts</h1>
          <h1 className=" text-3xl md:text-5xl lg:text-6xl font-semibold">for students today!</h1>
