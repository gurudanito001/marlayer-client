    ...
    <section id="studentDiscount" className="bg-accent2 border-t">
      ...
      <figure className="hidden lg:block h-full bg-accent2 bg-blend-darken md:bg-[url('/images/join-a-cohort-2.jpg')] bg-cover bg-center bg-no-repeat">
        ...
        <article className="flex flex-col py-14 lg:py-28 px-5 xl:pl-28">
          <h1 className=" text-2xl lg:text-7xl font-extrabold mt-auto">Join the next cohort</h1>
          <p className=" text-md md:text-xl font-550 mt-4">When you join the Marlayer Learning program, you become part of a community of high achievers.
          Here are some other benefits of learning from our program:
          </p>

          <ul className=" list-disc list-outside flex flex-col gap-3 lg:gap-5 text-sm lg:text-xl pl-4 md:pl-5 mt-5">
