      ...
      <section className="flex flex-col bg-white px-3 sm:px-5 xl:px-28 mt-10">
        <div className="breadcrumbs text-sm mb-10">
          <ul>
            ...
            <li><Link href="" className="text-primary font-semibold text-sm lg:text-xl capitalize">Backend Development for Beginners</Link></li>
          </ul>
        </div>
        <Syllabus />
      </section>
      <Pricing standard={60} premium={70} platinum={80} />
      <ForEnterprises />
