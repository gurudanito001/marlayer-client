...
// --- 1. Educational Background Icons Component ---
...
// --- 2. Types & Data (Only 3 Courses for Home Page) ---
type Course = {
  href: string;
  imageSrc: string;
  imageAlt: string;
...
export const CourseCard = ({ course }: { course: Course }) => (
  <div className="group flex flex-col bg-white/5 border border-white/5 rounded-[1.25rem] overflow-hidden transition-all duration-300 shadow-lg hover:-translate-y-1 h-full">
    ...
    <div className="p-5 flex flex-col flex-grow">
      <h3 className="text-lg font-semibold text-white mb-4 group-hover:text-[#45B1A0] transition-colors">
        {course.title}
      </h3>
      <div className="flex items-center justify-between text-xs text-gray-400 mb-6 font-medium mt-auto">
        ...
        <div className="flex items-center gap-1.5 text-gray-300">
          {/* Restored custom orange class for the star */}
      ...
      <div className="flex items-center justify-between pt-4 border-t border-white/10">
        ...
        <Link
          ...
          className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
            /* Restored custom orange class for the button */
            course.isActive ? 'bg-orange hover:bg-orange/85 text-white' : 'bg-white/10 text-gray-300 hover:bg-white/20'
          }`}
        >
          View Syllabus
        </Link>
...
const CoursePackages = () => {
  return (
    // Changed bg-[#0A1A18] to bg-[#050E0B] to match the All Courses page
    <section id="coursePackages" className="bg-[#050E0B] relative py-20 lg:py-28 font-sans overflow-hidden">
      <BackgroundIcons />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {homeCourses.map((course) => (
            <div key={course.href} className="w-full">
        ...
        <div className="w-full flex justify-center mt-4">
          <Link 
            href="/academy/viewAllCourses" 
            className="w-full sm:w-auto inline-flex justify-center items-center gap-3 bg-transparent border border-[#45B1A0] text-[#45B1A0] hover:bg-[#45B1A0] hover:text-[#0E1F18] font-bold text-sm px-10 py-4 rounded-xl transition-all duration-300 group shadow-[0_0_15px_rgba(69,177,160,0.1)] hover:shadow-[0_0_25px_rgba(69,177,160,0.3)]"
          >
            View All Courses
