...
export default function CTASection() {
  return (
    <section className="bg-gradient-to-b from-primary to-[#0E1F18] py-16 px-6 font-sans relative flex justify-center">
      ...
      <div className="relative w-full max-w-5xl bg-white/5 border border-white/5 rounded-[2rem] py-20 px-6 md:px-16 text-center shadow-2xl">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-semibold text-white mb-6 leading-tight max-w-3xl mx-auto">
          Join Productivity Academy And Achieve
          More With Deep Work Habits
        </h2>
        
        <p className="text-gray-300 text-sm leading-relaxed max-w-2xl mx-auto mb-10">
          Our program helps professionals, entrepreneurs, and students eliminate distractions, boost focus, and achieve peak productivity. Whether you're struggling with procrastination or looking to maximize your efficiency
        </p>
