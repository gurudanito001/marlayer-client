        ...
        <div>
          ...
          <article className="text-black flex flex-col px-4 py-7 border border-primary-2 rounded-lg hover:shadow-xl max-w-md">
            ...
            <div className="flex flex-col mb-10 gap-2">
              ...
              {/* <Link className="btn btn-lg px-10 hover:border-2 border-primary-2 bg-primary-2 text-white font-bold w-full rounded-lg" href="/academy/sign-up">Enroll Now</Link> */}
            </div>
        ...
        <div>
          ...
          <article className="text-black flex flex-col px-4 py-7 border border-primary rounded-lg rounded-t-none hover:shadow-xl max-w-md">
            ...
            <div className="flex flex-col mb-10 gap-2">
              ...
              {/* <Link className="btn btn-lg px-10 hover:border-2 border-primary bg-primary text-white font-bold w-full rounded-lg" href="/academy/sign-up">Enroll Now</Link> */}
            </div>
        ...
        <div>
          ...
          <article className="text-black flex flex-col px-4 py-7 border border-primary rounded-lg hover:shadow-xl max-w-md">
            ...
            <div className="flex flex-col mb-10 gap-2">
              ...
              {/* <Link className="btn btn-lg px-10 hover:border-2 border-secondary text-white font-bold w-full bg-secondary rounded-lg" href="/academy/sign-up">Enroll Now</Link> */}
            </div>
