  ...
  return (
    <footer className="bg-white text-gray-700 w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-200">
        ...
        {/* 2. About Column */}
        <div>
          <h3 className="uppercase text-sm font-semibold mb-4 text-gray-900 tracking-wider">ABOUT</h3>
        ...
        {/* 3. Contact Column */}
        <div>
          <h3 className="uppercase text-sm font-semibold mb-4 text-gray-900 tracking-wider">CONTACT</h3>
          <p className="text-sm">
            EleTechPRO@contact.com
          </p>
        ...
        <div className="flex space-x-2 justify-start">
          ...
          <Link href="https://twitter.com" target="_blank" rel="noopener noreferrer">
            <div className="w-10 h-10 bg-gray-800 hover:opacity-80 transition-opacity cursor-pointer flex items-center justify-center rounded">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
        ...
        <p>© copyright WPDeveloper {currentYear}</p>
