      ...
      <main className="min-h-screen bg-white py-12 px-6 md:px-10 lg:px-20">
        ...
        {loading ? (
          <div className="flex justify-center items-center min-h-[300px]">
            <p className="text-gray-500 animate-pulse">Loading laptops...</p>
          </div>
        ) : displayedLaptops.length === 0 ? (
          <div className="flex justify-center items-center min-h-[300px]">
            <p className="text-gray-500">No laptops found in this category.</p>
          </div>
        ) : (
            ...
            {displayedLaptops.map((product) => (
              <div key={product.id} className="flex flex-col text-center">
                ...
                <div className="flex justify-center items-center gap-2 mt-2">
                  {/* I left your routing exactly as you had it, but double check if it should just be /laptops/${product.id} */}
                  <Link
