      ...
      <div className="w-full py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <Link href="/gadgets/Phones" className="text-gray-700 hover:text-blue-600 transition">
              Phones
            </Link>

            <Link href="/gadgets/Laptops" className="text-gray-700 hover:text-blue-600 transition">
              Laptops
            </Link>

            <Link href="/gadgets/accessories" className="text-gray-700 hover:text-blue-600 transition">
              Accessories
            </Link>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            <ul className="menu p-4">
              ...
              <li><Link href="/gadgets/Phones" className="text-base text-gray-800 py-3" onClick={toggleMenu}>Phones</Link></li>
              <li><Link href="/gadgets/Laptops" className="text-base text-gray-800 py-3" onClick={toggleMenu}>Laptops</Link></li>
              <li><Link href="/gadgets/accessories" className="text-base text-gray-800 py-3" onClick={toggleMenu}>Accessories</Link></li>
            </ul>
          </div>
        </div>
      </div> 
