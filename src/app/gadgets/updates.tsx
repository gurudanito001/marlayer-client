  ...
  return (
    <div className="w-full px-6 py-20 flex justify-center">
      <div className="w-full max-w-5xl bg-[#F8F9FA] rounded-[32px] py-20 px-8 flex flex-col items-center text-center">
        ...
        {/* Title */}
        <h2 className="text-2xl lg:text-4xl font-semibold leading-snug max-w-3xl">
          Keep me updated about devices, best deals, news, tips and offers from Marlayer Gadgets.
        </h2>
